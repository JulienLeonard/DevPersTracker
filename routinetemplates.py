...
<head>
  <link type="text/css" rel="stylesheet" href="/stylesheets/main.css" />
    ...
    <form action="/doaddroutine/%s" method="post">
      <div><textarea name="routinename"         rows="1" cols="40"></textarea></div>
      <div><textarea name="routinedescription"  rows="1" cols="40"></textarea></div>
